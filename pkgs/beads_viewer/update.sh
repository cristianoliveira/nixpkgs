...
darwin_aarch64_url="${base_url}/bv_${version}_darwin_arm64.tar.gz"
darwin_amd64_url="${base_url}/bv_${version}_darwin_amd64.tar.gz"
linux_aarch64_url="${base_url}/bv_${version}_linux_arm64.tar.gz"
linux_amd64_url="${base_url}/bv_${version}_linux_amd64.tar.gz"
...
echo "Updated beads_viewer to v${version}"
