...
pkgs: {
  codex =
    let
      ...
      sha256 =
        if pkgs.stdenv.isDarwin then
          if pkgs.stdenv.isAarch64 then "sha256-8vaim8mD3/8QZytK/DXewkKVcrTH8JUjUgPZ6j8ojxs="
          else "sha256-8vaim8mD3/8QZytK/DXewkKVcrTH8JUjUgPZ6j8ojxs="
        else if pkgs.stdenv.isAarch64 then "sha256-34+vBxhfxHZokKSNfjhltZcsqU1jk894gpd26WsbG3E="
        else "sha256-34+vBxhfxHZokKSNfjhltZcsqU1jk894gpd26WsbG3E=";
